...
def run(tokens):
    ...
    classifier_weights = pd.read_csv(
        "output/length/rasp/hist/trainlength30/s4/hist_weights.csv",
        index_col=[0, 1],
        dtype={"feature": str},
    )
    # inputs #####################################################
    ...
    def predicate_0_1(q_position, k_position):
        ...
        elif q_position in {1, 18, 25}:
            return k_position == 29
        elif q_position in {2}:
            return k_position == 14
        elif q_position in {3, 7, 8, 9, 10}:
            return k_position == 27
        elif q_position in {4}:
            return k_position == 31
        elif q_position in {5, 11, 16, 17, 19}:
            return k_position == 28
        elif q_position in {24, 12, 29, 6}:
            return k_position == 11
        elif q_position in {35, 39, 13, 21, 22, 30}:
            return k_position == 9
        elif q_position in {32, 26, 14, 23}:
            return k_position == 7
