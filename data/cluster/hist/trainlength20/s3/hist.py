...
def run(tokens):
    ...
    classifier_weights = pd.read_csv(
        "output/length/rasp/hist/trainlength20/s3/hist_weights.csv",
        index_col=[0, 1],
        dtype={"feature": str},
    )
    # inputs #####################################################
    ...
    def predicate_0_0(q_position, k_position):
        ...
        elif q_position in {7, 9, 10, 16, 17, 19, 27, 28, 29}:
            return k_position == 1
        elif q_position in {8, 11, 13, 14, 15}:
            return k_position == 3
    ...
    def num_mlp_0_1(num_attn_0_1_output, num_attn_0_3_output):
        ...
        if key in {
            ...
            return 19
        elif key in {(0, 0), (0, 1), (1, 0), (1, 1), (2, 0), (3, 0), (4, 0)}:
            return 1
        return 21
