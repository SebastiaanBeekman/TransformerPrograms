...
def run(tokens):
    ...
    classifier_weights = pd.read_csv(
        "output/length/rasp/reverse/trainlength30/s0/reverse_weights.csv",
        index_col=[0, 1],
        dtype={"feature": str},
    )
    # inputs #####################################################
    ...
    def predicate_0_1(q_position, k_position):
        if q_position in {0}:
            ...
            return k_position == 2
        elif q_position in {15, 24, 25, 27, 28}:
            return k_position == 1
        elif q_position in {16, 37, 36, 29}:
            return k_position == 29
        elif q_position in {38, 17, 18, 21, 22}:
            return k_position == 5
    ...
    def predicate_0_2(q_position, k_position):
        if q_position in {0, 29, 15}:
            return k_position == 29
        elif q_position in {1, 3, 31}:
            return k_position == 25
        elif q_position in {2}:
            ...
            return k_position == 0
        elif q_position in {16, 23}:
            return k_position == 4
        elif q_position in {24, 17, 19, 25}:
            return k_position == 2
        elif q_position in {18, 20, 21, 22, 26, 27, 28}:
            return k_position == 1
    ...
    def predicate_0_3(q_position, k_position):
        if q_position in {0, 12}:
            ...
            return k_position == 17
        elif q_position in {4, 36, 6, 30}:
            return k_position == 20
        elif q_position in {9, 37, 5}:
            return k_position == 19
        elif q_position in {7}:
            return k_position == 14
        elif q_position in {35, 8, 17, 21, 22}:
            return k_position == 4
        elif q_position in {16, 10, 20, 23}:
            return k_position == 5
    ...
    def predicate_0_4(q_position, k_position):
        if q_position in {0, 6, 7, 12, 13, 14, 15, 16, 17, 29}:
            return k_position == 29
        elif q_position in {1}:
    ...
    def predicate_0_5(q_position, k_position):
        if q_position in {0}:
            ...
            return k_position == 16
        elif q_position in {8, 10, 12, 19, 27, 28, 29}:
            return k_position == 1
        elif q_position in {11}:
            return k_position == 15
        elif q_position in {13, 16, 21, 22, 23, 25, 26}:
            return k_position == 2
        elif q_position in {14}:
            return k_position == 0
        elif q_position in {15, 17, 18, 20, 24}:
            return k_position == 3
    ...
    def predicate_0_6(q_position, k_position):
        if q_position in {0, 35, 38}:
            ...
            return k_position == 11
        elif q_position in {9, 14, 16, 17, 22, 23, 28, 29}:
            return k_position == 1
        elif q_position in {10}:
            return k_position == 12
        elif q_position in {11, 12, 15, 18, 20, 21, 27}:
            return k_position == 2
    ...
    def num_predicate_0_4(q_position, k_position):
        if q_position in {0, 1, 11, 6}:
            return k_position == 12
        elif q_position in {2}:
            return k_position == 10
        elif q_position in {26, 3}:
            return k_position == 37
        elif q_position in {32, 4, 39, 23}:
            return k_position == 33
        elif q_position in {12, 5, 14}:
            return k_position == 31
        elif q_position in {7}:
            return k_position == 11
        elif q_position in {33, 36, 8, 10, 20}:
            return k_position == 39
        elif q_position in {16, 9, 34, 38}:
            return k_position == 38
        elif q_position in {13}:
            return k_position == 32
        elif q_position in {18, 15}:
            return k_position == 19
        elif q_position in {37, 17, 27, 29}:
            return k_position == 34
        elif q_position in {24, 19}:
            return k_position == 14
        elif q_position in {21}:
            return k_position == 24
        elif q_position in {28, 22, 30}:
            return k_position == 36
        elif q_position in {25}:
            return k_position == 23
        elif q_position in {31}:
    ...
    # mlp_0_0 #####################################################
    def mlp_0_0(attn_0_7_output):
        key = attn_0_7_output
        return 3

    mlp_0_0_outputs = [mlp_0_0(k0) for k0 in attn_0_7_outputs]
    ...
    # num_mlp_0_1 #################################################
    def num_mlp_0_1(num_attn_0_7_output, num_attn_0_2_output):
    ...
    def predicate_1_0(attn_0_6_output, token):
        if attn_0_6_output in {"4", "</s>", "0"}:
            return token == "0"
        elif attn_0_6_output in {"1"}:
            return token == "</s>"
        elif attn_0_6_output in {"3", "<s>", "2"}:
            return token == ""
    ...
    def predicate_1_1(num_mlp_0_0_output, token):
        if num_mlp_0_0_output in {0, 3, 9, 11, 16, 23, 26, 27}:
            return token == "0"
        elif num_mlp_0_0_output in {1, 33, 4, 5, 7, 39, 21, 28}:
            return token == ""
        elif num_mlp_0_0_output in {2, 36, 12, 22, 25}:
            return token == "3"
        elif num_mlp_0_0_output in {34, 37, 6, 38, 13, 15, 17, 20, 24, 29}:
            return token == "4"
        elif num_mlp_0_0_output in {35, 8, 10, 19, 30, 31}:
            return token == "1"
        elif num_mlp_0_0_output in {32, 18, 14}:
            return token == "2"
    ...
    def predicate_1_3(q_position, k_position):
        if q_position in {0, 16, 17, 31}:
            ...
            return k_position == 22
        elif q_position in {8, 10, 18, 20}:
            return k_position == 2
        elif q_position in {9}:
            return k_position == 13
        elif q_position in {11, 23, 26, 27, 28, 29}:
            return k_position == 1
        elif q_position in {33, 12}:
            return k_position == 15
        elif q_position in {13, 14, 15}:
            return k_position == 0
        elif q_position in {25, 19, 21, 22}:
            return k_position == 3
        elif q_position in {24}:
            return k_position == 4
        elif q_position in {35, 30}:
    ...
    # attn_1_4 ####################################################
    def predicate_1_4(attn_0_5_output, attn_0_6_output):
    ...
    attn_1_4_pattern = select_closest(attn_0_6_outputs, attn_0_5_outputs, predicate_1_4)
    ...
    # attn_1_5 ####################################################
    def predicate_1_5(attn_0_1_output, token):
        if attn_0_1_output in {"0"}:
            return token == ""
        elif attn_0_1_output in {"1"}:
            return token == "0"
    ...
    attn_1_5_pattern = select_closest(tokens, attn_0_1_outputs, predicate_1_5)
    ...
    # attn_1_6 ####################################################
    def predicate_1_6(attn_0_5_output, attn_0_6_output):
        if attn_0_5_output in {"4", "2", "<s>", "0", "1"}:
            return attn_0_6_output == ""
        elif attn_0_5_output in {"3"}:
            return attn_0_6_output == "</s>"
        elif attn_0_5_output in {"</s>"}:
    ...
    attn_1_6_pattern = select_closest(attn_0_6_outputs, attn_0_5_outputs, predicate_1_6)
    ...
    def predicate_1_7(attn_0_5_output, token):
        if attn_0_5_output in {"4", "2", "3", "<s>", "0", "1"}:
            return token == "3"
        elif attn_0_5_output in {"</s>"}:
            return token == "4"
    ...
    # num_attn_1_0 ####################################################
    def num_predicate_1_0(attn_0_6_output, attn_0_2_output):
        if attn_0_6_output in {"0"}:
            return attn_0_2_output == "0"
        elif attn_0_6_output in {"4", "2", "</s>", "3", "<s>", "1"}:
            return attn_0_2_output == ""

    num_attn_1_0_pattern = select(attn_0_2_outputs, attn_0_6_outputs, num_predicate_1_0)
    ...
    # num_attn_1_1 ####################################################
    def num_predicate_1_1(q_attn_0_5_output, k_attn_0_5_output):
        if q_attn_0_5_output in {"4", "2", "</s>", "3", "0", "1"}:
            return k_attn_0_5_output == ""
        elif q_attn_0_5_output in {"<s>"}:
            return k_attn_0_5_output == "<s>"

    num_attn_1_1_pattern = select(attn_0_5_outputs, attn_0_5_outputs, num_predicate_1_1)
    ...
    # num_attn_1_2 ####################################################
    def num_predicate_1_2(attn_0_4_output, position):
    ...
    num_attn_1_2_pattern = select(positions, attn_0_4_outputs, num_predicate_1_2)
    ...
    # num_attn_1_3 ####################################################
    def num_predicate_1_3(attn_0_6_output, attn_0_2_output):
        if attn_0_6_output in {"4", "2", "</s>", "<s>", "0", "1"}:
            return attn_0_2_output == ""
        elif attn_0_6_output in {"3"}:
            return attn_0_2_output == "3"

    num_attn_1_3_pattern = select(attn_0_2_outputs, attn_0_6_outputs, num_predicate_1_3)
    ...
    def num_predicate_1_4(attn_0_6_output, attn_0_2_output):
        if attn_0_6_output in {"4", "2", "</s>", "3", "<s>", "0"}:
            return attn_0_2_output == ""
        elif attn_0_6_output in {"1"}:
    ...
    # num_attn_1_5 ####################################################
    def num_predicate_1_5(attn_0_4_output, attn_0_6_output):
        if attn_0_4_output in {"4", "2", "</s>", "<s>", "0"}:
            return attn_0_6_output == ""
    ...
    num_attn_1_5_pattern = select(attn_0_6_outputs, attn_0_4_outputs, num_predicate_1_5)
    ...
    # num_attn_1_6 ####################################################
    def num_predicate_1_6(attn_0_5_output, token):
        if attn_0_5_output in {"4", "2", "</s>", "3", "<s>", "0"}:
            return token == ""
        elif attn_0_5_output in {"1"}:
            return token == "<s>"

    num_attn_1_6_pattern = select(tokens, attn_0_5_outputs, num_predicate_1_6)
    ...
    # num_attn_1_7 ####################################################
    def num_predicate_1_7(attn_0_6_output, token):
        if attn_0_6_output in {"4", "</s>", "3", "<s>", "0", "1"}:
            return token == ""
        elif attn_0_6_output in {"2"}:
            return token == "<s>"

    num_attn_1_7_pattern = select(tokens, attn_0_6_outputs, num_predicate_1_7)
    ...
    # mlp_1_0 #####################################################
    def mlp_1_0(mlp_0_1_output, attn_1_6_output):
        key = (mlp_0_1_output, attn_1_6_output)
        if key in {(32, "4")}:
            return 39
        return 4

    mlp_1_0_outputs = [
        mlp_1_0(k0, k1) for k0, k1 in zip(mlp_0_1_outputs, attn_1_6_outputs)
    ]
    ...
    # mlp_1_1 #####################################################
    def mlp_1_1(attn_1_1_output, num_mlp_0_1_output):
        key = (attn_1_1_output, num_mlp_0_1_output)
        return 11

    mlp_1_1_outputs = [
        mlp_1_1(k0, k1) for k0, k1 in zip(attn_1_1_outputs, num_mlp_0_1_outputs)
    ]
    ...
    # num_mlp_1_1 #################################################
    def num_mlp_1_1(num_attn_1_7_output, num_attn_1_6_output):
    ...
    # attn_2_0 ####################################################
    def predicate_2_0(attn_0_6_output, attn_1_2_output):
        if attn_0_6_output in {"2", "</s>", "3", "<s>", "0"}:
    ...
    attn_2_0_pattern = select_closest(attn_1_2_outputs, attn_0_6_outputs, predicate_2_0)
    ...
    # attn_2_1 ####################################################
    def predicate_2_1(attn_1_3_output, mlp_1_0_output):
        if attn_1_3_output in {"0"}:
            return mlp_1_0_output == 4
        elif attn_1_3_output in {"1", "3"}:
            ...
            return mlp_1_0_output == 20
        elif attn_1_3_output in {"<s>"}:
            return mlp_1_0_output == 7

    attn_2_1_pattern = select_closest(mlp_1_0_outputs, attn_1_3_outputs, predicate_2_1)
    ...
    # attn_2_2 ####################################################
    def predicate_2_2(attn_0_6_output, attn_1_4_output):
        if attn_0_6_output in {"4", "3", "0", "2"}:
    ...
    attn_2_2_pattern = select_closest(attn_1_4_outputs, attn_0_6_outputs, predicate_2_2)
    ...
    # attn_2_3 ####################################################
    def predicate_2_3(position, attn_1_7_output):
        if position in {0, 33, 6, 7, 8, 10, 11, 20, 26, 29, 31}:
            return attn_1_7_output == ""
        elif position in {32, 1, 2, 34, 4, 35, 37, 23, 27}:
            return attn_1_7_output == "3"
        elif position in {19, 3}:
            return attn_1_7_output == "4"
        elif position in {16, 5}:
            return attn_1_7_output == "<pad>"
        elif position in {38, 9, 21, 30}:
            return attn_1_7_output == "</s>"
        elif position in {36, 39, 12, 14, 15, 17, 22, 25}:
            return attn_1_7_output == "<s>"
        elif position in {24, 28, 13}:
            return attn_1_7_output == "1"
        elif position in {18}:
            return attn_1_7_output == "0"

    attn_2_3_pattern = select_closest(attn_1_7_outputs, positions, predicate_2_3)
    ...
    # attn_2_4 ####################################################
    def predicate_2_4(position, attn_0_1_output):
        if position in {0, 32, 2, 3, 4, 5, 6, 7, 34, 36, 38, 39, 29, 31}:
            ...
            return attn_0_1_output == "</s>"
        elif position in {33, 35, 37, 26, 30}:
            return attn_0_1_output == ""

    attn_2_4_pattern = select_closest(attn_0_1_outputs, positions, predicate_2_4)
    ...
    # attn_2_5 ####################################################
    def predicate_2_5(attn_0_3_output, num_mlp_0_1_output):
    ...
    attn_2_5_pattern = select_closest(
        num_mlp_0_1_outputs, attn_0_3_outputs, predicate_2_5
    )
    ...
    # attn_2_6 ####################################################
    def predicate_2_6(position, attn_0_5_output):
        if position in {0, 32, 35, 36, 7, 17, 31}:
            return attn_0_5_output == "0"
        elif position in {1, 14, 16, 22, 26, 27}:
            return attn_0_5_output == ""
        elif position in {19, 2, 3, 13}:
            return attn_0_5_output == "</s>"
        elif position in {33, 4, 29, 38}:
            return attn_0_5_output == "3"
        elif position in {25, 21, 5}:
            return attn_0_5_output == "4"
        elif position in {20, 28, 6}:
            return attn_0_5_output == "1"
        elif position in {8, 9, 10, 12, 23, 24}:
            return attn_0_5_output == "<s>"
        elif position in {11, 30}:
            return attn_0_5_output == "<pad>"
        elif position in {34, 37, 39, 15, 18}:
            return attn_0_5_output == "2"

    attn_2_6_pattern = select_closest(attn_0_5_outputs, positions, predicate_2_6)
    ...
    # num_attn_2_0 ####################################################
    def num_predicate_2_0(mlp_1_1_output, attn_0_2_output):
    ...
    num_attn_2_0_pattern = select(attn_0_2_outputs, mlp_1_1_outputs, num_predicate_2_0)
    ...
    # num_attn_2_1 ####################################################
    def num_predicate_2_1(attn_1_4_output, attn_1_3_output):
        if attn_1_4_output in {"4", "2", "</s>", "<s>", "0", "1"}:
            return attn_1_3_output == ""
        elif attn_1_4_output in {"3"}:
            return attn_1_3_output == "</s>"

    num_attn_2_1_pattern = select(attn_1_3_outputs, attn_1_4_outputs, num_predicate_2_1)
    ...
    # num_attn_2_2 ####################################################
    def num_predicate_2_2(attn_0_6_output, attn_0_2_output):
        if attn_0_6_output in {"4", "</s>", "3", "<s>", "0", "1"}:
            return attn_0_2_output == ""
        elif attn_0_6_output in {"2"}:
            return attn_0_2_output == "2"

    num_attn_2_2_pattern = select(attn_0_2_outputs, attn_0_6_outputs, num_predicate_2_2)
    ...
    # num_attn_2_3 ####################################################
    def num_predicate_2_3(attn_1_5_output, attn_0_7_output):
        if attn_1_5_output in {"4", "2", "</s>", "3", "<s>", "0", "1"}:
            return attn_0_7_output == ""

    num_attn_2_3_pattern = select(attn_0_7_outputs, attn_1_5_outputs, num_predicate_2_3)
    ...
    # num_attn_2_4 ####################################################
    def num_predicate_2_4(attn_1_1_output, attn_1_3_output):
        if attn_1_1_output in {"4", "2", "</s>", "3", "0", "1"}:
            return attn_1_3_output == ""
        elif attn_1_1_output in {"<s>"}:
            return attn_1_3_output == "<pad>"

    num_attn_2_4_pattern = select(attn_1_3_outputs, attn_1_1_outputs, num_predicate_2_4)
    ...
    def num_predicate_2_5(attn_1_3_output, attn_1_0_output):
        if attn_1_3_output in {"2", "</s>", "3", "<s>", "0", "1"}:
    ...
    # num_attn_2_6 ####################################################
    def num_predicate_2_6(attn_0_6_output, attn_0_2_output):
        if attn_0_6_output in {"2", "</s>", "3", "<s>", "0", "1"}:
            return attn_0_2_output == ""
        elif attn_0_6_output in {"4"}:
            return attn_0_2_output == "4"

    num_attn_2_6_pattern = select(attn_0_2_outputs, attn_0_6_outputs, num_predicate_2_6)
    ...
    def num_predicate_2_7(attn_1_7_output, attn_0_4_output):
        ...
        elif attn_1_7_output in {"4", "2", "3", "<s>", "1"}:
    ...
    # mlp_2_0 #####################################################
    def mlp_2_0(attn_2_7_output, mlp_1_0_output):
        key = (attn_2_7_output, mlp_1_0_output)
        return 1

    mlp_2_0_outputs = [
        mlp_2_0(k0, k1) for k0, k1 in zip(attn_2_7_outputs, mlp_1_0_outputs)
    ]
    ...
    # mlp_2_1 #####################################################
    def mlp_2_1(num_mlp_0_1_output, num_mlp_1_0_output):
        key = (num_mlp_0_1_output, num_mlp_1_0_output)
        return 9

    mlp_2_1_outputs = [
        mlp_2_1(k0, k1) for k0, k1 in zip(num_mlp_0_1_outputs, num_mlp_1_0_outputs)
    ]
    ...
    # num_mlp_2_0 #################################################
    def num_mlp_2_0(num_attn_2_7_output, num_attn_1_1_output):
        key = (num_attn_2_7_output, num_attn_1_1_output)
        return 2

    num_mlp_2_0_outputs = [
        num_mlp_2_0(k0, k1)
        for k0, k1 in zip(num_attn_2_7_outputs, num_attn_1_1_outputs)
    ]
    ...
    # num_mlp_2_1 #################################################
    def num_mlp_2_1(num_attn_1_5_output, num_attn_1_2_output):
